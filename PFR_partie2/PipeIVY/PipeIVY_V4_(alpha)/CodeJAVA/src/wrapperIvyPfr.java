 ...
 * Trames de la forme ID - ADDR - DATA1 - DATA2 et si DATA1 et DATA2 = 0x00 acquitement
*/
public class wrapperIvyPfr{
    ...
    public void launchIndexation(Motor motor,final int addrTypeTraitement){
    ...
    public List<ScorePath> sendRequete(Motor motor, final int addrTypeTraitement,String requete,int nombreResultatMax){
    ...
    public void setAffConsole(boolean affConsole){
        this.affConsole=affConsole;
    }
    public boolean getAffConsole(){
        return affConsole;
    }
}