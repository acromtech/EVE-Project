#ifndef INDEXATION_TEXTE
#define INDEXATION_TEXTE
...
descripteurEtScoreListe rechercheTexteMotCle(pathIdDesc, tableDescript, char *);
descripteurEtScoreListe rechercheTexteCompare(const volatile baseDescripteur, pathIdDesc, char *);
