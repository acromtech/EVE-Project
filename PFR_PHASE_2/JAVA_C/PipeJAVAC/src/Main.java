...
public class Main{
    public static void main(String[] args) {
        ...
        Motor motor1=new Motor(1,"/Moteur1/CodeC/","main",".config1");   //1 étant l'id souhaité et "main.out" la cible du makefile
        
        //Motor motor3=new Motor(2,"/Moteur3/CodeC","ouvert",".config3");   //2 étant l'id souhaité et "main.out" la cible du makefile
        bus.addMotor(motor1);
...
*/
        ...
        */
        ...
        //List<ScorePath> scoreRequete4=bus.sendRechercheComplexe(motor1,Bus.ADDR_TEXTE_MOTCLE, "stockage",10);
        //Tools.printScorePathList(scoreRequete4);


        //List<ScorePath> scoreRequete2=bus.sendWord(motor1,Bus.ADDR_TEXTE_FICHIER,"../../BaseFichier/Texte/06-La_contamination_du_ma∩s_par.xml",10);
        //Tools.printScorePathList(scoreRequete2);
        //bus.launchIndexation(motor1,Bus.ADDR_INDEXATION_ALL);
