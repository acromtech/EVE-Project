...
char* cheminAudio = "../../BaseFichier/Son/";
char* cheminBaseDescripteur="../FichierIndexation/Son/BaseDescripteursAudios/";
char* cheminListeDescripteur="../FichierIndexation/Son/ListeDescripteursAudios/ListeDescripteursAudios.txt";
...
void autoIndexationAudio(){

	struct dirent *dir;
	DIR *d = opendir(cheminAudio); 
