...
public class AffichageResultatRechercheCouleurController {
    ...
    private final String filename1 = "34.jpg";
    private final String filename2 = "35.jpg";
    private final String filename3 = "28.jpg";
    private final String filename4 = "";
    private final String filename5 = "";
