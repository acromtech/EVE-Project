...
public class affichageResultatRechercheAudioController {
    ...
    public void rowClicked(MouseEvent event) throws IOException {
        ...
        String audioFilePath = "src/main/resources/com/son/corpus_fi.wav";
        ...
        try {
            ...
            long startPosition = 28000; // par exemple 5 secondes
    ...
    private void setupTable() {
        Resultat histos0 = new Resultat(1, "Corpus_fi.wav", "29s", "src/main/resources/com/son/corpus_fi.wav");
        Resultat histos1 = new Resultat(1, "Corpus_fi.wav", "25s", "src/main/resources/com/son/corpus_fi.wav");
        Resultat histos2 = new Resultat(1, "Corpus_fi.wav", "33s", "src/main/resources/com/son/corpus_fi.wav");
