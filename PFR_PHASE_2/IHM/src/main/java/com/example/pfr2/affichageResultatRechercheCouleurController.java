...
public class affichageResultatRechercheCouleurController {
    @FXML
    ...
    private String filename1 = "34.jpg";
    private String filename2 = "35.jpg";
    private String filename3 = "28.jpg";
    ...
    public void onAfficheImage() throws IOException {
        String filename1 = "34.jpg";
        String filename2 = "35.jpg";
        String filename3 = "28.jpg";
        String filename4 = "";
        String filename5 = "";
        String filename6 = "";
        String filename7 = "";
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename1);
        File dir2 = new File("src/main/resources/com/images/JPG/"+filename2);
        File dir3 = new File("src/main/resources/com/images/JPG/"+filename3);
        File dir4 = new File("src/main/resources/com/images/JPG/"+filename4);
        File dir5 = new File("src/main/resources/com/images/JPG/"+filename5);
        File dir6 = new File("src/main/resources/com/images/JPG/"+filename6);
        File dir7 = new File("src/main/resources/com/images/JPG/"+filename7);
        File dir8 = new File("src/main/resources/com/images/JPG/"+filename8);
        ...
        titre1.setText("34.jpg");
        titre2.setText("35.jpg");
        titre3.setText("28.jpg");
    ...
    void onOuvreImage2() throws IOException{
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename2);
        Image img1 = new Image(dir1.toURI().toURL().toExternalForm());
        VboxPremierPlan.toBack();
        image9.toFront();
        image9.setVisible(true);
    ...
    void onOuvreImage3() throws IOException{
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename3);
        Image img1 = new Image(dir1.toURI().toURL().toExternalForm());
        VboxPremierPlan.toBack();
        image9.toFront();
        image9.setVisible(true);
    ...
    void onOuvreImage4() throws IOException{
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename4);
        Image img1 = new Image(dir1.toURI().toURL().toExternalForm());
        VboxPremierPlan.toBack();
        image9.toFront();
        image9.setVisible(true);
    ...
    void onOuvreImage5() throws IOException{
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename5);
        Image img1 = new Image(dir1.toURI().toURL().toExternalForm());
        VboxPremierPlan.toBack();
        image9.toFront();
        image9.setVisible(true);
    ...
    void onOuvreImage6() throws IOException{
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename6);
        Image img1 = new Image(dir1.toURI().toURL().toExternalForm());
        VboxPremierPlan.toBack();
        image9.toFront();
        image9.setVisible(true);
    ...
    void onOuvreImage7() throws IOException{
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename7);
        Image img1 = new Image(dir1.toURI().toURL().toExternalForm());
        VboxPremierPlan.toBack();
        image9.toFront();
        image9.setVisible(true);
    ...
    void onOuvreImage8() throws IOException{
        ...
        File dir1 = new File("src/main/resources/com/images/JPG/"+filename8);
        Image img1 = new Image(dir1.toURI().toURL().toExternalForm());
        VboxPremierPlan.toBack();
        image9.toFront();
        image9.setVisible(true);
